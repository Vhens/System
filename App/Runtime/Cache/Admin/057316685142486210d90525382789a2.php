      ...
      <form class="form-signin" action="index.html">
        ...
        <div class="login-wrap">
            ...
            <div class="radios text-center">
                <input id="radio-1" name="radio" type="radio" checked><label for="radio-1"></label>男
                <input id="radio-2" name="radio" type="radio"><label for="radio-2"></label>女
            </div>
            <input type="text" class="form-control" placeholder="用户名" autofocus>
            <input type="password" class="form-control" placeholder="密码">
            <input type="password" class="form-control" placeholder="确认密码">
            <input type="text" class="form-control dib w50" placeholder="验证码">
